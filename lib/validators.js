...
import { SUBMISSION_CANDIDATE_SOURCE_VALUES } from '@/lib/submission-candidate-source-options';
...
export const jobOrderSchema = z
	.object({
		...
		currency: z.enum(['USD', 'CAD', 'AUD']).default('USD'),
...
export const submissionSchema = z.object({
	...
	candidateSource: z
		.union([z.enum(SUBMISSION_CANDIDATE_SOURCE_VALUES), z.literal(''), z.null(), z.undefined()])
		.optional(),
